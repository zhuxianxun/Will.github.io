...
I am a postdoctoral researcher at Macquarie University, Australia, while maintaining active research collaboration with Nanyang Technological University (NTU). I work closely with [**Xiaohan Yu**](https://scholar.google.com/citations?user=3PURN9QAAAAJ&hl=zh-CN) and [**Erik Cambria, IEEE Fellow**](https://scholar.google.com.hk/citations?hl=zh-CN&user=ilSYpW0AAAAJ&view_op=list_works&sortby=pubdate), with research interests spanning **multimodal emotion analysis**, **wireless/6G sensing**, **robotics SLAM**, and **remote sensing**. My broader interests also include **AI algorithms**, **blockchain business analysis**, and **microelectronic chip development**. I collaborate closely with both academia and industry to translate advanced research into practical and deployable systems.
